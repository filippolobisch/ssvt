...
counterModel :: IOLTS
counterModel = createIOLTS
      [(1, "?coin", 2), (1, "?coin", 3), (2, "!tea", 4), (3, "!coffee", 5)]
...
coffeeImpl3 :: IOLTS
coffeeImpl3 = createIOLTS
      [(1, "?coin", 2), (2, "!coffee", 3), (1, "?button", 2), (1, "?tea", 2)]
coffeeModel3 :: IOLTS
...
coffeeModel4 :: IOLTS
coffeeModel4 = createIOLTS
      [(1, "?button", 2), (2, "!tea", 3), (1, "?coin", 4), (4, "!coffee", 5)]
...
tretmanK1 :: IOLTS
tretmanK1 = createIOLTS
      [(0, "?but", 1), (1, "?but", 1), (1, "!liq", 2), (2, "?but", 2)]

tretmanK2 :: IOLTS
tretmanK2 = createIOLTS
      [ (0, "?but" , 1)
      , (1, "?but" , 1)
      , (1, "!liq" , 2)
      , (2, "?but" , 2)
...
tretmanS3 :: IOLTS
tretmanS3 =
      createIOLTS [(0, "?a", 1), (1, "!x", 2), (0, "?b", 3), (3, "!y", 4)]

tretmanS4 :: IOLTS
tretmanS4 = createIOLTS [(0, "?a", 1), (1, "!x", 2), (1, tau, 3)]

tretmanR1 :: IOLTS
tretmanR1 = createIOLTS
      [ (0, "?but" , 1)
      , (1, "?but" , 1)
      , (0, "?but" , 2)
      , (1, "!liq" , 3)
...
createIOLTS transitions =
      ( states
      , map tail $ filter (\x -> head x == '?') labels
      , map tail $ filter (\x -> head x == '!') labels
      , map (\(f, l, t) -> (f, makeLabel l, t)) transitionSet
      , initState
      )
...
createLTS transitions =
      ( states
      , filter (/= tau) $ makeSet (map (\(_, label, _) -> label) transitions)
      , makeSet transitions
      , head states
      )
   where
...
simonResult =
      ...
      , ["delta", "delta", "delta", "coin"]
      , ["delta", "delta", "coin", "coffee"]
      , ["delta", "delta", "coin", "tea"]
      , ["delta", "coin", "coffee", "delta"]
